...
function UserProfile() {
  ...
  src="https://img.daisyui.com/images/stock/photo-1567653418876-5bb0e566e1c2.webp" />
        <button className="btn btn-wide">Upload Profile Picture</button>
        </div>
  ...
  type="text"
  placeholder="#"
  className="input input-bordered w-full max-w-xs bg-white placeholder-black" readOnly
   />
        </div>
    <div>
    <button onClick={handleSignOut} className="btn bg-red-700 border-red-700 text-white shadow-xl
">Sign Out</button>
    </div>
    </div>
    </>
